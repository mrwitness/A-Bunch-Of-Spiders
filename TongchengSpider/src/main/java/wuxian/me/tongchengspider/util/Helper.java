package wuxian.me.tongchengspider.util;
...
public class Helper {
    ...
    public static Headers getTongchengHeader(String host, @NotNull String reference) {
        builder.set("Host", host);
        return getHeaderBySpecifyRef(reference, "Tongcheng");
    }

    public static Headers getSpiderHeader(String host, @NotNull String reference) {
        builder.set("Host", host);
        return getHeaderBySpecifyRef(reference, "Lianjia");
    }
